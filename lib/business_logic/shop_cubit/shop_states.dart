...
class ShopGetBannersLoadingState extends ShopStates {}

class ShopGetBannersSuccessState extends ShopStates {}

class ShopGetBannersErrorState extends ShopStates {
  final String error;

  ShopGetBannersErrorState(this.error);
}
